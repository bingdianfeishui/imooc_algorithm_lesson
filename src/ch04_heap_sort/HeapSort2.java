 ...
 * 优化了MaxHeapOp1中shiftUp、shiftDown,效率变化不大
 * 
 * @author Lee
 *
 */
public class HeapSort2 implements ISorter {
	...
	public int[] sort(int[] arr) {
		MaxHeapBasic heap = new MaxHeapOp1(arr.length + 1);
